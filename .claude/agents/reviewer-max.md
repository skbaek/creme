---
name: reviewer-max
description: Master's hostile reviewer; never repairs, model-diverse from the author. Effort max: the ceiling: one coupled non-delegable chain; compare against xhigh. Model is chosen at dispatch.
