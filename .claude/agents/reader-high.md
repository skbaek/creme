---
name: reader-high
description: Master's read-only reader; no build, no hold. Effort high: complex implementation or proof repair along a known architecture. Model is chosen at dispatch.
