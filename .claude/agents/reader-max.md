---
name: reader-max
description: Master's read-only reader; no build, no hold. Effort max: the ceiling: one coupled non-delegable chain; compare against xhigh. Model is chosen at dispatch.
