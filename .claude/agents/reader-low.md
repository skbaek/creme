---
name: reader-low
description: Master's read-only reader; no build, no hold. Effort low: short falsifiable route: inventories, direct edits, routine checks. Model is chosen at dispatch.
