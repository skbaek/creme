---
name: reviewer-low
description: Master's hostile reviewer; never repairs, model-diverse from the author. Effort low: short falsifiable route: inventories, direct edits, routine checks. Model is chosen at dispatch.
